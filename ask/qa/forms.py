...
class AnswerForm(forms.Form):
    ...
    def clean_question(self):
        ...
        if question == 0:
            raise forms.ValidationError(
                'Question number error', code='validation_error'
            )
        return question
...
class SignupForm(forms.Form):
    ...
    def clean_username(self):
        ...
        if username.strip() == '':
            raise forms.ValidationError(
                'Username is empty', code='validation_error'
            )
        return username
    ...
    def clean_email(self):
        ...
        if email.strip() == '':
            raise forms.ValidationError(
                'Email is empty', code='validation_error')
        return email
    ...
    def clean_password(self):
        ...
        if password.strip() == '':
            raise forms.ValidationError(
                'Password is empty', code='validation_error')
        return password
